...
namespace clk.Resources
{
    public static class About
    {
        ...
        public static void usage()
        {
            ...
            Console.WriteLine("-p --check   Select (Point) checklist");
            Console.WriteLine();
            ...
            Console.WriteLine("Create a checklist (-p) point: clk -b=2 -l=1 -c=5 -p=3 --checkp=\"New checklist point\"");
            Console.WriteLine("Create a checklist w/ points:  clk -b=2 -l=1 -c=5 --new-check=\"To Profit\" --new-point=\"This\" --new-point=\"That\"");
            Console.WriteLine();
